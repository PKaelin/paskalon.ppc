...
{
    /// <summary>
    /// Voltage var droop mode configuration.
    /// </summary
    public class VoltageVarDroopModeConfig : OperatingClosedModeBaseConfig
    {
        /// <summary>
        ...
        public override required CurveBaseConfig? CurveConfig
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException($"{nameof(CurveConfig)} must be of type {nameof(VoltVarCurveConfig)}");
                }
