...
namespace paskalON.OperatingModes.Domain.ClosedModes.FrequencyActives
{
    public class FrequencyDroopMode : OperatingClosedModeBase
    {
        ...
        public FrequencyDroopMode(ILogger logger, TimeProvider timeProvider, IMetricsPublisher publisher, SystemConfig systemConfig, FrequencyDroopModeConfig config,
