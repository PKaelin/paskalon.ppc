...
namespace paskalON.OperatingModes.Domain.OpenModes.FrequencyActives
{
    ...
    public class ActivePowerFixedMode : OperatingOpenModeBase
    {
        ...
        public ActivePowerFixedMode(ILogger logger, TimeProvider timeProvider, IMetricsPublisher publisher, SystemConfig systemConfig, ActivePowerFixedModeConfig config,
