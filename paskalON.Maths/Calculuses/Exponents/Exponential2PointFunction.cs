...
namespace paskalON.Maths.Calculuses.Exponents
{
    ...
    /// </summary>
    public class Exponential2PointFunction : IPiecewiseFunction
    {
        /// <summary>
        ...
        public Exponential2PointFunction((double X, double Y) point1, (double X, double Y) point2, double offset = 0, int digits = 3)
            : this(point1, point2, offset, 0, 0, digits)
        {
        }
        ...
        /// <param name="digits">Digits to round the output to</param>
        public Exponential2PointFunction((double X, double Y) point1, (double X, double Y) point2, double offset, double noiseMin, double noiseMax, int digits = 3)
        {
