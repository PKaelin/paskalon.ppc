...
namespace paskalON.PowerControls.Infrastructure.Storage.Configurations
{
    ...
    /// </summary>
    public class DerUnitEnergyStoragePowerControlConfiguration : IEntityTypeConfiguration<DerUnitEnergyStoragePowerControlConfig>
    {
        /// <summary>
        /// Configures the entity of type TEntity.
        /// </summary>
        /// <param name="builder">The builder to be used to configure the entity type.</param>
        public void Configure(EntityTypeBuilder<DerUnitEnergyStoragePowerControlConfig> builder)
        {
